...
module.exports = function (cmd) {
		...
		self.json  	 	= [];
		self.path 		= "";
		self.repo_source = '/etc/apt/sources.list';
	   ...
	   */
		...
		this.get_software_list = function () {
			...
			console.log(cls.green('Collecting installed software list from ubuntu machine......'));
		...
		*/
		...
		console.log(cls.green('packing json files....'));
		...
		/**
		 * Reads from a .json file , then calls installer method in order to execute commands
		 */
		this.run = function () {
		...
		/**
		 * The installer method takes software list and repository list and run the commands
		 *  repository lists are store in /etc/apt/source.list
		 *  Then installation commands are executed
		 */
		...
		/**
		 * Getting all command from here , brain function , this method decides what to with users command
		 * @param  {[string]} cmd [command from user]
		 */
